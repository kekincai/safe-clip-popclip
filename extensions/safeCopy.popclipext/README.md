...
Copy selected text after locally redacting common secrets and personal data. The original text is left unchanged.
...
All processing happens inside PopClip. safeCopy has no network entitlement, does not read files and does not persist the selected text.
...
Pattern matching can miss unusual formats or redact harmless text that resembles sensitive data. Review the copied text before sharing it.
